...
view_job_history_blueprint = Blueprint('view_job_history', __name__)

class ViewJobHistoryController:
    @view_job_history_blueprint.route('/api/cleaner/view_job_history', methods=['GET'])
    @jwt_required()
    @login_required
